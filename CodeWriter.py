...
class CodeWriter:
    ...
    # https://github.com/profsergiocosta/vm-translator/tree/813f9e4a8064dee5a4362721e1540352038ae37e/codewriter
    # wrong version
    ...
    def write_arithmetic_gt(self):
        ...
        labelTrue = f"JGT_TRUE_{self.module_name}_{self.label_count}"
        labelFalse = f"JGT_FALSE_{self.module_name}_{self.label_count}"
        ...
        self.write_line("AM=M-1")
        self.write_line("D=M-D")
        self.write_line("@" + labelTrue)
        self.write_line("D;JGT")
        self.write_line("D=0")
        self.write_line("@" + labelFalse)
        self.write_line("0;JMP")
        self.write_line("(" + labelTrue + ")")
        self.write_line("D=-1")
        self.write_line("(" + labelFalse + ")")
    ...
    def write_arithmetic_lt(self):
        ...
        labelTrue = f"JLT_TRUE_{self.module_name}_{self.label_count}"
        labelFalse = f"JLT_FALSE_{self.module_name}_{self.label_count}"
